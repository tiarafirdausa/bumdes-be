...
exports.protect = (req, res, next) => {
    ...
    try {
        ...
        return res.status(401).json({ error: 'Token tidak valid atau kadaluarsa. Silakan login kembali.' });
    }
};

// Middleware opsional: Membatasi akses berdasarkan level pengguna
